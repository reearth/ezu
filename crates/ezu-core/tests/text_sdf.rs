...
//! the shared encoder in `tests/glyph_pbf` and against a vendored real
//! range — see `tests/glyphs/README.md`), MapLibre metrics, lazy range
//! fetching, and the SDF draw passes.
...
mod glyph_pbf;
use glyph_pbf::{box_glyph, box_sdf, encode_range};
